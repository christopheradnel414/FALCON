...
def coarsening(edge_index, coarsening_ratio, coarsening_method):
    
    G = gsp.graphs.Graph(W=to_dense_adj(edge_index)[0])
...
def load_data(train_mask, val_mask, features, labels, n_classes, candidate, C_list, Gc_list):
